      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 text-center">
        ...
        <Reveal delay={280}>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <Link to="/auth">
              <Button size="lg" className="bg-primary text-primary-foreground neon-border h-12 px-6 transition-transform hover:-translate-y-0.5">
                Start uploading <ArrowRight className="ml-2 size-4" />
              </Button>
            </Link>
            <Link to="/app/docs">
              <Button size="lg" variant="outline" className="h-12 px-6 glass transition-transform hover:-translate-y-0.5">
                Read the docs
              </Button>
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            <Reveal key={f.title} delay={i * 70}>
              <div className="glass rounded-2xl p-6 hover:neon-border transition hover:-translate-y-1 duration-300 h-full">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-5">
          {[
            ...
            <Reveal key={p.name} delay={i * 100} y={32}>
              <div className={`glass rounded-2xl p-8 text-left transition hover:-translate-y-1 duration-300 ${p.featured ? "neon-border" : ""}`}>
